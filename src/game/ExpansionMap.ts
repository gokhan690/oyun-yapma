...
export const EXPANSION_CITIES: CityDef[] = [
  ...
  { id: 'ankara', label: 'Ankara', emoji: '🏛️', unlockCost: 500_000, repReq: 40, ipoReq: 0, skylineClass: 'city-ankara', rivalFamily: 'Sabanoğlu' },
  { id: 'izmir', label: 'İzmir', emoji: '🌊', unlockCost: 2_000_000, repReq: 50, ipoReq: 0, skylineClass: 'city-izmir', rivalFamily: 'Koçak' },
