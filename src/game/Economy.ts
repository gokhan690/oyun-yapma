...
export const PRODUCERS: ProducerDef[] = [
  ...
  { id: 'insaat', name: 'İnşaat Firması', emoji: '🏗️', description: 'Konut ve ticari projeler.', tier: 4, unlockAt: 360_000, baseCost: 1_950, baseIncome: 26, costMultiplier: 1.22 },
  { id: 'hukuk', name: 'Hukuk Bürosu', emoji: '⚖️', description: 'Kurumsal dava ve danışmanlık.', tier: 4, unlockAt: 400_000, baseCost: 2_100, baseIncome: 28, costMultiplier: 1.22 },
  ...
  { id: 'geri_donusum', name: 'Geri Dönüşüm Tesisi', emoji: '♻️', description: 'Atıktan hammadde.', tier: 4, unlockAt: 440_000, baseCost: 2_000, baseIncome: 27, costMultiplier: 1.22 },
  ...
  { id: 'ic_mimar', name: 'İç Mimar Ağı', emoji: '🛋️', description: 'Villa ve otel tasarım projeleri.', tier: 4, unlockAt: 320_000, baseCost: 1_900, baseIncome: 26, costMultiplier: 1.22 },
  { id: 'tatil_koyu', name: 'Tatil Köyü', emoji: '🏖️', description: 'All-inclusive resort zinciri.', tier: 4, unlockAt: 360_000, baseCost: 2_050, baseIncome: 28, costMultiplier: 1.22, category: 'luxury' },
