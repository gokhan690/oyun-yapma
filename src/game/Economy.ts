...
export const PRODUCERS: ProducerDef[] = [
  ...
  { id: 'fabrika', name: 'Lojistik Merkezi', emoji: '🚚', description: 'Tedarik zinciri güçleniyor.', tier: 4, unlockAt: 480_000, baseCost: 2_088, baseIncome: 41, costMultiplier: 1.22 },
  { id: 'mobil_app', name: 'Mobil Uygulama', emoji: '📱', description: 'Abonelik geliri akıyor.', tier: 4, unlockAt: 480_000, baseCost: 2_088, baseIncome: 45, costMultiplier: 1.22 },
  { id: 'holding', name: 'Yazılım Şirketi', emoji: '💻', description: 'Teknoloji imparatorluğu.', tier: 5, unlockAt: 8_000_000, baseCost: 4_108, baseIncome: 130, costMultiplier: 1.22 },
  ...
  { id: 'kripto', name: 'Kripto Borsası', emoji: '₿', description: 'Volatil ama kârlı dijital pazar.', tier: 5, unlockAt: 8_000_000, baseCost: 4_108, baseIncome: 139, costMultiplier: 1.19 },
  ...
  { id: 'bahis', name: 'Gizli Bahis Ağı', emoji: '🎲', description: 'Yüksek gelir, yüksek risk.', tier: 3, unlockAt: 110_000, baseCost: 1_365, baseIncome: 26, costMultiplier: 1.25, illegal: true, riskChance: 0.06, riskFinePct: 0.18 },
  { id: 'piramit', name: 'Piramit Şema', emoji: '🔺', description: 'Kısa vadede patlar, uzun vadede yakalanırsın.', tier: 5, unlockAt: 8_000_000, baseCost: 4_977, baseIncome: 196, costMultiplier: 1.25, illegal: true, riskChance: 0.05, riskFinePct: 0.22 },
  ...
  { id: 'data_center', name: 'Veri Merkezi', emoji: '🖥️', description: 'Bulut altyapısı kiraları.', tier: 4, unlockAt: 480_000, baseCost: 2_088, baseIncome: 48, costMultiplier: 1.22 },
  ...
  { id: 'medya', name: 'Medya Holding', emoji: '📺', description: 'Haber, reklam ve içerik imparatorluğu.', tier: 4, unlockAt: 480_000, baseCost: 2_088, baseIncome: 51, costMultiplier: 1.22 },
  { id: 'streaming', name: 'Streaming Platformu', emoji: '🎬', description: 'Abonelik ve reklam geliri.', tier: 4, unlockAt: 480_000, baseCost: 2_088, baseIncome: 55, costMultiplier: 1.22 },
  { id: 'ilac', name: 'İlaç Laboratuvarı', emoji: '💊', description: 'Ar-Ge ve patent gelirleri.', tier: 5, unlockAt: 8_000_000, baseCost: 4_108, baseIncome: 149, costMultiplier: 1.22 },
  { id: 'sigorta', name: 'Sigorta Şirketi', emoji: '🛡️', description: 'Prim ve yatırım getirisi.', tier: 5, unlockAt: 8_000_000, baseCost: 4_108, baseIncome: 158, costMultiplier: 1.22 },
  ...
  { id: 'siyaset_belediye', name: 'Belediye Meclisi', emoji: '🏛️', description: 'Yerel siyasette ilk adım.', tier: 4, unlockAt: 480_000, baseCost: 2_160, baseIncome: 68, costMultiplier: 1.22, category: 'politics' },
  ...
  { id: 'kacak_imalat', name: 'Kaçak İmalat Hattı', emoji: '🔧', description: 'Vergisiz üretim, yüksek risk.', tier: 4, unlockAt: 480_000, baseCost: 2_952, baseIncome: 126, costMultiplier: 1.25, illegal: true, category: 'dark', riskChance: 0.07, riskFinePct: 0.16 },
  { id: 'siyah_fabrika', name: 'Siyah Fabrika', emoji: '🏭', description: 'Radar altında yasadışı üretim.', tier: 5, unlockAt: 8_000_000, baseCost: 5_846, baseIncome: 275, costMultiplier: 1.25, illegal: true, category: 'dark', riskChance: 0.06, riskFinePct: 0.20 },
  { id: 'silah_ticareti', name: 'Silah Kaçakçılığı', emoji: '🔫', description: 'Tehlikeli ama çok kârlı ağ.', tier: 7, unlockAt: 40_000_000, baseCost: 21_204, baseIncome: 248, costMultiplier: 1.21, illegal: true, category: 'dark', riskChance: 0.05, riskFinePct: 0.25 },
  ...
  { id: 'hukuk', name: 'Hukuk Bürosu', emoji: '⚖️', description: 'Kurumsal dava ve danışmanlık.', tier: 4, unlockAt: 400_000, baseCost: 2_100, baseIncome: 58, costMultiplier: 1.22 },
  ...
  { id: 'oyun_studio', name: 'Oyun Stüdyosu', emoji: '🎮', description: 'Indie oyunlar, büyük hitler.', tier: 4, unlockAt: 150_000, baseCost: 2_400, baseIncome: 86, costMultiplier: 1.22 },
  ...
  { id: 'emlak_ofis', name: 'Emlak Ofisi', emoji: '🏠', description: 'Komisyon ve kiralama geliri.', tier: 4, unlockAt: 180_000, baseCost: 2_200, baseIncome: 72, costMultiplier: 1.22 },
  { id: 'hastane', name: 'Özel Hastane', emoji: '🏥', description: 'Sağlık turizmi ve sigorta.', tier: 5, unlockAt: 450_000, baseCost: 4_800, baseIncome: 180, costMultiplier: 1.19 },
  { id: 'universite', name: 'Özel Üniversite', emoji: '🎓', description: 'Kampüs, araştırma, öğrenim.', tier: 5, unlockAt: 650_000, baseCost: 5_400, baseIncome: 237, costMultiplier: 1.19 },
  { id: 'havayolu', name: 'Havayolu Şirketi', emoji: '✈️', description: 'Yolcu ve kargo hatları.', tier: 6, unlockAt: 1_800_000, baseCost: 8_900, baseIncome: 108, costMultiplier: 1.19 },
  { id: 'liman', name: 'Liman İşletmesi', emoji: '⚓', description: 'Konteyner ve gemi trafiği.', tier: 6, unlockAt: 2_500_000, baseCost: 9_600, baseIncome: 120, costMultiplier: 1.19 },
  { id: 'ruzgar', name: 'Rüzgar Enerji Parkı', emoji: '🌬️', description: 'Offshore türbinler.', tier: 6, unlockAt: 2_200_000, baseCost: 9_100, baseIncome: 114, costMultiplier: 1.19 },
  { id: 'maden', name: 'Maden Ocağı', emoji: '⛏️', description: 'Ham madde ihracatı.', tier: 5, unlockAt: 800_000, baseCost: 6_200, baseIncome: 294, costMultiplier: 1.19 },
  { id: 'nukleer', name: 'Nükleer Santral', emoji: '☢️', description: 'Dev yatırım, dev güç.', tier: 7, unlockAt: 8_000_000, baseCost: 16_800, baseIncome: 167, costMultiplier: 1.20 },
  { id: 'tarim_tek', name: 'Tarım Teknoloji Kooperatifi', emoji: '🌾', description: 'Dikey tarım ve tohum patenti.', tier: 5, unlockAt: 550_000, baseCost: 5_100, baseIncome: 212, costMultiplier: 1.19 },

  // —— Lüks (milyoner+) — pahalı kalır ——
  { id: 'yacht_filo', name: 'Süper Yat Filosu', emoji: '🛥️', description: 'Charter ve özel seyir.', tier: 8, unlockAt: 40_000_000, baseCost: 32_000, baseIncome: 332, costMultiplier: 1.21, category: 'luxury' },
  { id: 'formula1', name: 'Formula 1 Takımı', emoji: '🏎️', description: 'Podyum, sponsor, marka değeri.', tier: 9, unlockAt: 180_000_000, baseCost: 62_000, baseIncome: 521, costMultiplier: 1.22, category: 'luxury' },
  { id: 'casino_legal', name: 'Casino İmparatorluğu', emoji: '🎰', description: 'Las Vegas tarzı zincir.', tier: 8, unlockAt: 55_000_000, baseCost: 38_500, baseIncome: 367, costMultiplier: 1.21, category: 'luxury' },
  { id: 'adalar', name: 'Özel Ada Zinciri', emoji: '🏝️', description: 'Ultra lüks resort portföyü.', tier: 9, unlockAt: 250_000_000, baseCost: 78_000, baseIncome: 565, costMultiplier: 1.22, category: 'luxury' },
  { id: 'saat_marka', name: 'Lüks Saat Markası', emoji: '⌚', description: 'Swiss craftsmanship imajı.', tier: 7, unlockAt: 15_000_000, baseCost: 19_500, baseIncome: 214, costMultiplier: 1.20, category: 'luxury' },
  { id: 'jet_filo', name: 'Özel Jet Filosu', emoji: '🛩️', description: 'Business aviation kiralama.', tier: 8, unlockAt: 70_000_000, baseCost: 42_000, baseIncome: 405, costMultiplier: 1.21, category: 'luxury' },
  ...
  { id: 'moda_evi', name: 'Haute Couture Moda Evi', emoji: '👗', description: 'Podyum ve parfüm imparatorluğu.', tier: 8, unlockAt: 48_000_000, baseCost: 35_000, baseIncome: 349, costMultiplier: 1.21, category: 'luxury' },

  // —— Finans (sermaye oyunu) ——
  { id: 'banka_ozel', name: 'Özel Yatırım Bankası', emoji: '🏛️', description: 'HNWI müşteri portföyü.', tier: 7, unlockAt: 11_000_000, baseCost: 18_000, baseIncome: 177, costMultiplier: 1.20, category: 'finance' },
  { id: 'hedge_fund', name: 'Hedge Fon', emoji: '📊', description: 'Agresif getiri stratejileri.', tier: 8, unlockAt: 38_000_000, baseCost: 30_500, baseIncome: 316, costMultiplier: 1.21, category: 'finance' },
  { id: 'private_equity', name: 'Private Equity Fonu', emoji: '💼', description: 'Şirket al, birleştir, sat.', tier: 8, unlockAt: 60_000_000, baseCost: 40_000, baseIncome: 386, costMultiplier: 1.22, category: 'finance' },
  { id: 'venture_capital', name: 'Venture Capital', emoji: '🚀', description: 'Unicorn avcısı.', tier: 7, unlockAt: 18_000_000, baseCost: 21_000, baseIncome: 237, costMultiplier: 1.20, category: 'finance' },
  { id: 'family_office', name: 'Family Office', emoji: '👨‍👩‍👧‍👦', description: 'Hanedan servet yönetimi.', tier: 9, unlockAt: 300_000_000, baseCost: 85_000, baseIncome: 593, costMultiplier: 1.22, category: 'finance' },
  { id: 'reasurans', name: 'Reasürans Şirketi', emoji: '📋', description: 'Sigortacıların sigortacısı.', tier: 6, unlockAt: 3_500_000, baseCost: 11_200, baseIncome: 126, costMultiplier: 1.19, category: 'finance' },
  { id: 'borsa_araci', name: 'Aracı Kurum', emoji: '📉', description: 'Komisyon ve margin geliri.', tier: 6, unlockAt: 4_000_000, baseCost: 12_000, baseIncome: 140, costMultiplier: 1.19, category: 'finance' },

  // —— Bilim & uzay ——
  { id: 'biyotek', name: 'Biyoteknoloji Lab', emoji: '🧬', description: 'Gen düzenleme ve ilaç.', tier: 7, unlockAt: 14_000_000, baseCost: 20_500, baseIncome: 225, costMultiplier: 1.20, category: 'science' },
  { id: 'uzay_istasyonu', name: 'Uzay İstasyonu Modülü', emoji: '🛸', description: 'Düşük yörünge laboratuvarı.', tier: 9, unlockAt: 220_000_000, baseCost: 72_000, baseIncome: 538, costMultiplier: 1.22, category: 'science' },
  { id: 'uydu_fab', name: 'Uydu Üretim Tesisi', emoji: '🏭', description: 'Yörüngeye seri üretim.', tier: 8, unlockAt: 85_000_000, baseCost: 48_000, baseIncome: 471, costMultiplier: 1.21, category: 'science' },
  { id: 'havacilik', name: 'Havacılık Ar-Ge Merkezi', emoji: '🔭', description: 'Hipersonik ve savunma.', tier: 8, unlockAt: 95_000_000, baseCost: 52_000, baseIncome: 495, costMultiplier: 1.21, category: 'science' },
  { id: 'gen_terapi', name: 'Gen Terapisi Kliniği', emoji: '💉', description: 'Yaşam süresi uzatma pazarı.', tier: 7, unlockAt: 20_000_000, baseCost: 23_500, baseIncome: 275, costMultiplier: 1.20, category: 'science' },
  { id: 'superbilgisayar', name: 'Süper Bilgisayar Merkezi', emoji: '💻', description: 'AI eğitim kapasitesi kirala.', tier: 8, unlockAt: 65_000_000, baseCost: 44_500, baseIncome: 426, costMultiplier: 1.21, category: 'science' },
  ...
  { id: 'basketbol', name: 'Profesyonel Basketbol Ligi', emoji: '🏀', description: 'Franchise ve yayın hakları.', tier: 7, unlockAt: 16_000_000, baseCost: 22_000, baseIncome: 262, costMultiplier: 1.20, category: 'sport' },
  { id: 'espor', name: 'eSpor Organizasyonu', emoji: '🎯', description: 'Turnuva, sponsor, skin.', tier: 5, unlockAt: 700_000, baseCost: 5_800, baseIncome: 262, costMultiplier: 1.19, category: 'sport' },
  ...
  { id: 'siyaset_lobi', name: 'Uluslararası Lobi Ağı', emoji: '🤝', description: 'Devletler arası nüfuz.', tier: 9, unlockAt: 350_000_000, baseCost: 88_000, baseIncome: 623, costMultiplier: 1.22, category: 'politics' },
  { id: 'cyber_kara', name: 'Siber Suç Şebekesi', emoji: '💻', description: 'Veri ve fidye geliri.', tier: 6, unlockAt: 20_000_000, baseCost: 13_500, baseIncome: 147, costMultiplier: 1.22, illegal: true, category: 'dark', riskChance: 0.06, riskFinePct: 0.22 },
  { id: 'kripto_aklama', name: 'Kripto Aklama Hattı', emoji: '🪙', description: 'Mixer ve offshore zincir.', tier: 7, unlockAt: 100_000_000, baseCost: 26_000, baseIncome: 287, costMultiplier: 1.23, illegal: true, category: 'dark', riskChance: 0.05, riskFinePct: 0.20 },
  { id: 'veri_broker', name: 'Veri Brokerlığı', emoji: '📡', description: 'Gölge pazar istihbaratı.', tier: 8, unlockAt: 300_000_000, baseCost: 45_000, baseIncome: 445, costMultiplier: 1.22, illegal: true, category: 'dark', riskChance: 0.04, riskFinePct: 0.18 },
  ...
  { id: 'gizli_kumarhane', name: 'Yeraltı Kumarhane Ağı', emoji: '🎰', description: 'VIP salonlar, yüksek bahis, yüksek risk.', tier: 4, unlockAt: 580_000, baseCost: 2_480, baseIncome: 92, costMultiplier: 1.25, illegal: true, riskChance: 0.08, riskFinePct: 0.18 },
  { id: 'banka_dolandirici', name: 'Fintech Dolandırıcılığı', emoji: '🕵️', description: 'Sahte yatırım platformları, phishing.', tier: 4, unlockAt: 700_000, baseCost: 2_780, baseIncome: 112, costMultiplier: 1.25, illegal: true, category: 'dark', riskChance: 0.07, riskFinePct: 0.20 },
  { id: 'organize_suc', name: 'Organize Suç Sendikası', emoji: '🦅', description: 'Haraç, koruma, kara ekonomi koordinasyonu.', tier: 5, unlockAt: 3_400_000, baseCost: 6_800, baseIncome: 308, costMultiplier: 1.25, illegal: true, category: 'dark', riskChance: 0.06, riskFinePct: 0.25 },
  { id: 'paralel_banka', name: 'Gölge Bankacılık', emoji: '🏦', description: 'Kayıt dışı kredi ve sermaye.', tier: 6, unlockAt: 18_000_000, baseCost: 11_500, baseIncome: 132, costMultiplier: 1.21, illegal: true, category: 'dark', riskChance: 0.05, riskFinePct: 0.22 },
  ...
  { id: 'market_zincir', name: 'Market Zinciri', emoji: '🛍️', description: 'Mahalle marketlerinden zincire.', tier: 2, unlockAt: 4_000, baseCost: 520, baseIncome: 11, costMultiplier: 1.17 },
  ...
  { id: 'catering', name: 'Catering Şirketi', emoji: '🍱', description: 'Kurumsal etkinlik yemekleri.', tier: 3, unlockAt: 50_000, baseCost: 1_400, baseIncome: 30, costMultiplier: 1.22 },
  { id: 'guvenlik', name: 'Güvenlik Şirketi', emoji: '🛡️', description: 'Özel koruma ve alarm.', tier: 3, unlockAt: 60_000, baseCost: 1_480, baseIncome: 33, costMultiplier: 1.22 },
  { id: 'egitim_app', name: 'Eğitim Uygulaması', emoji: '📚', description: 'Online kurs ve abonelik.', tier: 3, unlockAt: 75_000, baseCost: 1_620, baseIncome: 37, costMultiplier: 1.22 },
  ...
  { id: 'coworking', name: 'Coworking Ağı', emoji: '🏢', description: 'Esnek ofis kiralama.', tier: 4, unlockAt: 140_000, baseCost: 2_300, baseIncome: 79, costMultiplier: 1.22 },
  { id: 'mobilya', name: 'Mobilya Fabrikası', emoji: '🪑', description: 'Perakende ve toptan üretim.', tier: 4, unlockAt: 170_000, baseCost: 2_500, baseIncome: 100, costMultiplier: 1.22 },
  { id: 'radyo', name: 'Radyo & Podcast Ağı', emoji: '🎙️', description: 'Yayın hakları ve reklam.', tier: 4, unlockAt: 200_000, baseCost: 2_650, baseIncome: 106, costMultiplier: 1.22 },
  { id: 'mikrokredi', name: 'Mikrokredi Kurumu', emoji: '💳', description: 'Küçük işletmelere kredi.', tier: 4, unlockAt: 250_000, baseCost: 2_850, baseIncome: 120, costMultiplier: 1.19, category: 'finance' },
  { id: 'su_aritma', name: 'Su Arıtma Tesisi', emoji: '💧', description: 'Endüstriyel ve belediye sözleşmeleri.', tier: 5, unlockAt: 480_000, baseCost: 4_600, baseIncome: 170, costMultiplier: 1.19 },
  { id: 'yazilim_outsource', name: 'Yazılım Outsource', emoji: '👨‍💻', description: 'Global yazılım projeleri.', tier: 5, unlockAt: 580_000, baseCost: 5_000, baseIncome: 189, costMultiplier: 1.19 },
  { id: 'kuyumcu', name: 'Kuyumcu Zinciri', emoji: '💍', description: 'Altın ve mücevher.', tier: 5, unlockAt: 750_000, baseCost: 5_600, baseIncome: 250, costMultiplier: 1.19, category: 'luxury' },
  { id: 'telekom', name: 'Telekom Operatörü', emoji: '📡', description: 'Mobil ve fiber altyapı.', tier: 6, unlockAt: 1_600_000, baseCost: 8_500, baseIncome: 103, costMultiplier: 1.19 },
  { id: 'nft_borsa', name: 'Dijital Varlık Borsası', emoji: '🖼️', description: 'NFT ve token ticareti.', tier: 6, unlockAt: 6_000_000, baseCost: 14_000, baseIncome: 156, costMultiplier: 1.20, category: 'finance' },
  { id: 'golf_kulup', name: 'Uluslararası Golf Kulübü', emoji: '⛳', description: 'Üyelik ve turnuva geliri.', tier: 7, unlockAt: 13_000_000, baseCost: 18_500, baseIncome: 204, costMultiplier: 1.20, category: 'luxury' },
  { id: 'arastirma_enst', name: 'Araştırma Enstitüsü', emoji: '🔭', description: 'Patent ve lisans gelirleri.', tier: 8, unlockAt: 100_000_000, baseCost: 55_000, baseIncome: 520, costMultiplier: 1.21, category: 'science' },
  ...
  { id: 'fitness_app', name: 'Fitness Uygulaması', emoji: '🏃', description: 'Antrenman aboneliği ve PT.', tier: 4, unlockAt: 400_000, baseCost: 2_100, baseIncome: 62, costMultiplier: 1.22 },
  { id: 'fulfillment', name: 'Fulfillment Merkezi', emoji: '📦', description: 'E-ticaret depo ve lojistik.', tier: 4, unlockAt: 440_000, baseCost: 2_150, baseIncome: 65, costMultiplier: 1.22 },

  // —— YENİ: Tier 5 içerik ——
  { id: 'online_egitim', name: 'Online Eğitim Platformu', emoji: '🎓', description: 'Kurs, sertifika ve bootcamp.', tier: 5, unlockAt: 1_600_000, baseCost: 4_000, baseIncome: 125, costMultiplier: 1.19 },
  { id: 'biyoteknoloji', name: 'Biyoteknoloji Firması', emoji: '🧬', description: 'CRISPR, ilaç geliştirme.', tier: 5, unlockAt: 2_400_000, baseCost: 5_200, baseIncome: 223, costMultiplier: 1.19, category: 'science' },
]
...
export const ECONOMY_INCOME_RATIO = 0.06
